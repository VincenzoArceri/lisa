...
public interface NonRelationalHeapDomain<T extends NonRelationalHeapDomain<T>>
	...
	/**
	 * Checks if the given expression is satisfied in a given heap environment 
	 ...
	 *         boolean value)
	 */
	Satisfiability satisfies(SymbolicExpression currentExpression, HeapEnvironment<T> heapEnvironment);
}
